...
private:
    ...
    static constexpr float VOLTAGE_REFERENCE = 3.27;
    static constexpr float R1 = 4700.0;
    static constexpr float R2 = 10000.0;
    static constexpr uint8_t NUM_SAMPLES = 10;//20  //3000
    static constexpr uint16_t MS_BETWEEN_READS = 50;//50  // 3000
...
public:
    ...
    BATTERY_STATUS get_status() const {
        ...
        if (cached_voltage < 3.0) return BATTERY_DISCONNECTED;
